...
# train the tree using raw data
dat2=data.frame(x=t(Quantile_TMT_Summary_Data), y=as.factor(category))
out.tre2<-tree(y~., dat2)
# plot the tree
plot(out.tre2)
text(out.tre2)
# predict response
Y.tre2<-predict(out.tre2, dat2, type="class")
sum(Y.tre2 != as.factor(category)) / length(category)
```
