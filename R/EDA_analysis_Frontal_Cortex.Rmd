...
# FC - Frontal Cortex
FC_Data <- read_excel("../data/TMT_Summary_Data.xlsx", sheet=1, skip=2)
...
# Save the data
save(filtered_TMT_Summary_Data, file='../data/filtered_TMT_Summary_Data_FC.RData')
```
...
p + scale_color_manual(values= batchColors) +
    ...
    ggsave(file='../Figures/Fig1a-FrontalCortex.png')
...
save(Quantile_TMT_Summary_Data, file='../data/Quantile_TMT_Summary_Data_FC.RData')
...
p2 + scale_color_manual(values= batchColors) +
     ...
     ggsave(file='../Figures/Fig1b-FrontalCortex.png')
...
PCA <- prcomp(t(qData))
png('../Figures/Fig2-Frontal-Cortex.png')
